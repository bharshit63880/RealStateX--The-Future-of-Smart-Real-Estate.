...
describe('engagement validation',()=>{
  ...
  it('accepts rescheduling with a date',()=>{expect(bookingStatusSchema.safeParse({body:{status:'RESCHEDULED',scheduledFor:new Date(Date.now()+3600000)}}).success).toBe(true);});
