...
export const createAccessToken = (user) => jwt.sign({ sub: user.id, role: user.role, ver: user.securityVersion||0, type: 'access' }, config.jwt.accessSecret, { expiresIn: config.jwt.accessExpiresIn, issuer: 'realstatex', audience: 'realstatex-web' });
